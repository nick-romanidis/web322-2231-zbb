...
const helloModule = require("./modules/myModule");
...
app.get("/name", (req, res) => {
    let helloName = helloModule.sayHello("Nick");
    res.send(helloName);
});
...
app.get("/nameq", (req, res) => {
    ...
    let helloName = helloModule.sayHello(name || "No Name");
    res.send(helloName);
});

// http://localhost:8080/namep/Joan
